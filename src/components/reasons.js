export default [
  {
    ...
    reasonBigHeading: `A Drive-in ON the way`,
  ...
  {
    id: 9,
    reasonBy: `<strong>ERICA - HALIFAX,</strong> NS`,
    reasonBigHeading: `Throwing Shade`,
    reasonDescription: `<p>Each year we take a vacation with our Van; a trip out west to Montreal / Toronto, or sometimes to a rental cottage in New Brunswick or P.E.I. Having a roomy van provides space for both - people and luggage. Keeping our two boys calm during the trip takes some planning and work. In the past we used parchment paper to keep the interior cool, but with the new <strong>Sienna we have Sunshades that roll up from Sliding Doors.</strong>. Honestly, it keeps everyone cooler in more ways than one.</p>`,
    reasonDescriptionTablet: `<p>Each year we take a vacation with our Van; a trip out west to Montreal / Toronto, or sometimes to a rental cottage in New Brunswick or P.E.I. Having a roomy van provides space for both - people and luggage. Keeping our two boys calm during the trip takes some planning and work. In the past we used parchment paper to keep the interior cool, but with the new <strong>Sienna we have Sunshades that roll up from Sliding Doors.</strong>. Honestly, it keeps everyone cooler in more ways than one.</p>`,
    reasonGridTitle: `I can do so many things`,
    reviewBy: `NEIL VORANO`,
  ...
  },
  {
    ...
    reasonDescription: `<p>Our family is crazy for road trips! Which is good, because grandma lives down the highway in Calgary and we have some cousins in Vancouver. And while the pre-teens are keen to go, they also need a bit of entertainment sometimes, if not for anything else but to stay out of mom and dad’s hair. They need movies, games or music - entertainment that keeps them occupied until we get to our destination. <strong>They spend almost the whole trip watching movies and more importantly, staying quiet.</strong></p>`,
  ...
  {
    id: 17,
    reasonBy: `<strong>GEOFF,</strong> ST. JOHN’S, NL`,
  ...
  {
    id: 18,
    reasonBy: `<strong>NOUR - HAMILTON</strong>, ON`,
    reasonBigHeading: `Taking Everything with You`,
    reasonDescription: `<p>My parents have always loved camping and last year they gave us their small but very cool camp trailer. <strong>This has been a game-changer for us in the summer; no more setting up and folding tents, no more cooking under a tarp in the rain.</strong> We can now camp in style! And luckily, it’s just small enough for us to tow it behind our van. This old camper is now part of our life, and maybe someday we’ll pass it on to our kids – but not yet.</p>`,
  ...
  {
    id: 20,
    reasonBy: `<strong>THOMAS, KELOWNA</strong>, BC`,
    reasonBigHeading: `A Concert on the Go`,
    reasonDescription: `<p>A minivan works on many levels for my family. I’m on the road a lot with my sales job and I like the added room for material samples. I appreciate the alone time too. For one thing, it’s great I can pair my phone with Bluetooth and take calls on the road. <strong>Driving while my favourite tunes play on the satellite radio - it’s a great feeling.</strong></p>`,
    reasonDescriptionTablet: `<p>A minivan works on many levels for my family. I’m on the road a lot with my sales job and I like the added room for material samples. I appreciate the alone time too. For one thing, it’s great I can pair my phone with Bluetooth and take calls on the road. <strong>Driving while my favourite tunes play on the satellite radio - it’s a great feeling.</strong></p>`,
    reasonGridTitle: `We can keep everyone warm and happy in our Sienna.`,
    reviewBy: `NEIL VORANO`,
