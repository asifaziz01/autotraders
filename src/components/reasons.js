export default [
  ...
  },
  {
    ...
    reasonDescription: `<p>Our family is crazy for road trips! Which is good, because grandma lives down the highway in Calgary and we have some cousins in Vancouver. While the pre-teens are keen to go, they also need a bit of entertainment sometimes, if not for anything else but to stay out of mom and dad’s hair! Movies, games and music keep them occupied <strong>for the whole trip and more importantly they are quiet!</strong></p>`,
